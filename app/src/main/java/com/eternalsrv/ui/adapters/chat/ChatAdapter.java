...
import com.eternalsrv.ui.chat.AttachmentImageActivity;
import com.eternalsrv.ui.widget.MaskedImageView;
...
//        }
    ...
    private void setIncomingOrOutgoingMessageAttributes(ViewHolder holder, QBChatMessage chatMessage) {
        ...
        int messageBodyContainerBgResource = isIncoming
                ? R.drawable.incoming_message
                : R.drawable.outgoing_message;
        if (hasAttachments(chatMessage)) {
        ...
        holder.messageContainerLayout.setPadding(12, 0, 12, 2);
