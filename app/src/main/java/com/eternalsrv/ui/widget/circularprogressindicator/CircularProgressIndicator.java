...
public class CircularProgressIndicator extends View {
    ...
    private void drawProgress(Canvas canvas) {
        LinearGradient shader = new LinearGradient(0, 0, circleBounds.width(), circleBounds.height() * 1.2f, ResourceUtils.getColor(R.color.primary_blue_light), ResourceUtils.getColor(R.color.primary_purple_dark), Shader.TileMode.CLAMP);
